...
PROJECT_NAME="controla-pontos"  # Nome do projeto
DOMAIN="controla-pontos.picbrand.dev.br"  # Domínio configurado no Nginx
PROJECT_PATH="/home/ec2-user/controla-pontos-Lollapalooza-2025-Bradesco"  # Caminho do projeto no servidor
