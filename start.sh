...
cd /home/ec2-user/controla-pontos-Lollapalooza-2025-Bradesco  # Caminho do projeto
...
server {
    listen 80;
    server_name controla-pontos.picbrand.dev.br;
...
server {
    ...
    ssl_certificate /etc/letsencrypt/live/controla-pontos.picbrand.dev.br/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/controla-pontos.picbrand.dev.br/privkey.pem;
...
if [ -f "/etc/letsencrypt/live/controla-pontos.picbrand.dev.br/fullchain.pem" ]; then
    echo "✅ Certificado SSL já existe. Pulando a geração."
else
    echo "⚡ Gerando certificado SSL..."
    sudo certbot certonly --nginx -d controla-pontos.picbrand.dev.br --non-interactive --agree-tos -m seuemail@exemplo.com
fi
